...
export const PROJECTS: Project[] = [
  new Project(
    ...
    [
      ...
      new Label('Symfony', 'back', 'symfony', 'https://symfony.com/')
    ],
    [
      new Label('Angular', 'front', 'angular', 'https://angular.io/'),
      ...
      new Label('Symfony', 'back', 'symfony', 'https://symfony.com/'),
      new Label('API Platform', 'back', 'apiplatform', 'https://api-platform.com/')
    ],
    ...
    'That is why the director of the student house hire me to develop a website to manage the booking of the room of the student house.',
    'I created a frontend in Angular which call a Symfony API. ' +
    ...
    'Then all the users which don\'t appear on the Excel are deleted.' ,
    [],
    new Link('Booking Room Website', 'http://reservationcome.me-mines-saint-etienne.org/')
  ),
  new Project(
    ...
    'We first segmented White Matter Hyperintensities from brain MRIs thank to deep learning. ' +
    ...
    [
      ...
      new Link('First challenge web site', 'http://wmh.isi.uu.nl/'),
      new Link('Description of our method for the first challenge ', 'assets/description_wmh.pdf'),
      new Link('Second challenge web site', 'http://mrbrains18.isi.uu.nl/'),
      new Link('Description of our method for the second challenge ', 'assets/description_mrbrain.pdf'),
    ],
    null,
    'stage_2a_illustration.png'
  ),
  new Project(
    'Personal Website',
    'spc',
  ...
  new Project(
    ...
    [
      ...
      new Link('Project description by Robin Camarasa', '/assets/projet_info.pdf'),
    ],
